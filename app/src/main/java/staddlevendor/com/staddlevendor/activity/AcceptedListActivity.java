...
//            }
            ...
            orderMenuAdapter = new OrderMenuAdapter(AcceptedListActivity.this, orderList);
...
//        promocode_layout = findViewById(R.id.promocode_layout);
        ...
        rvShopping.setLayoutManager(new LinearLayoutManager(AcceptedListActivity.this));
    }

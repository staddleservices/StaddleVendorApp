...
public class PendingListAdapter extends RecyclerView.Adapter<PendingListAdapter.MyViewHolder> {
    ...
    public PendingListAdapter(Context mContext, ArrayList<PendingListModel> pendingListModelArrayList, String tag) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, @SuppressLint("RecyclerView") final int position) {
        try {
            final PendingListModel pendingListModel = pendingListModelArrayList.get(position);
